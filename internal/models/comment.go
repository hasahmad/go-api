...
type Comment struct {
	...
	ContentTypeID       uuid.UUID     `db:"model_type_id" json:"model_type_id"`
	ContentTypeRecordID uuid.UUID     `db:"model_type_record_id" json:"model_type_record_id"`
...
func NewComment(
	...
	return Comment{
		...
		ContentTypeRecordID: contentTypeRecordID,
